package com.zl.way.h5app.api.model;
...
public class WayQueryArticlePost {
    ...
    private String commodityImage = null;
    ...
    public WayQueryArticlePost commodityImage(String commodityImage) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.postId, wayQueryArticlePost.postId)
            ...
            && Objects.equals(this.commodityImage, wayQueryArticlePost.commodityImage)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(postId, commodityId, commodityName, commodityImage, subject, postContent, publishTime,
            postStatus, preAction);
    }

...
public class FetchElemeShopJob {
    ...
    private JSONArray getShopListJson(int offset) {
        ...
        String url = MessageFormat.format(
            "https://www.ele.me/restapi/shopping/restaurants?extras%5B%5D=activities&geohash=yb4h6zdz12nc&latitude=45.789471&limit=24&longitude=126.687189&offset={0}&terminal=web",
            offset);
    ...
    private String getJson(String url) {
        ...
        Request request = new Request.Builder().url(url).header("upgrade-insecure-requests", "1")
            .header(":authority", "www.ele.me").header(":method", "GET")
            .header("user-agent",
                "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36")
            .header("referer", "https://www.ele.me/place/yb4h6zdz12nc?latitude=45.789471&longitude=126.687189")
            .header("cookie",
    ...
    private class DiscountData {
        ...
        public void getCommodityJson(Long shopId) throws Exception {
            ...
            try {
                String url =
                    String.format("https://www.ele.me/restapi/shopping/v2/menu?restaurant_id=%s&terminal=web", shopId);
                ...
                if (null != commodityJsonArray && commodityJsonArray.size() > 0) {
                    ...
                    BigDecimal price = hotJsonObject.getJSONArray("specfoods").getJSONObject(0).getBigDecimal("price");
                    setPrice(price);
                }
            } catch (Exception e) {
        ...
        public String toString() {
            ...
            return "DiscountData{" + "shopAddress='" + shopAddress + '\'' + ", shopLatitude=" + shopLatitude
                + ", shopLongitude=" + shopLongitude + ", commodityName='" + commodityName + '\'' + ", commodityCate='"
                + commodityCate + '\'' + ", price=" + price + ", cideCode='" + cideCode + '\'' + '}';
        }
    }
}

...
@Component public class PushDiscountShopFollowJob {
    private final Logger logger = LoggerFactory.getLogger(getClass());

    private WayDiscountJpushService discountJpushService;

    @Autowired public PushDiscountShopFollowJob(WayDiscountJpushService discountJpushService) {
        this.discountJpushService = discountJpushService;
    }

    @Scheduled(fixedDelay = 3600000 * 6) public void doJob() {

...
public class WayDiscountApi {
    ...
    public ResponseResult<List<WayDiscountResponse>> queryDiscountList(@RequestBody WayDiscountRequest wayDiscountRequest) {
        ...
        List<WayDiscountResponse> wayDiscountResponseList = BeanMapper.mapAsList(wayDiscountBoList, WayDiscountResponse.class);
    ...
    public ResponseResult<WayDiscountResponse> increateDiscountReal(@RequestBody WayDiscountRequest wayDiscountRequest) {
